#
#  Be sure to run `pod spec lint TCNewFeatureView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "TardisCXX"
  # s.authors            = { "TardisCXX" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/TardisCXX"
